...
### 🧪 Demo pública del clasificador de tools MCP

El modelo fine-tuneado para selección de tools MCP está disponible como demo pública en Hugging Face Space:
...
Puedes ingresar una pregunta en español y ver qué tool sugiere el modelo.
